                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td title="Código">{{$produto->codigo}}</td>
                                        <td title="Nome">{{$produto->nome}}</td>
                                        <td title="Preço">R$ {{number_format($produto->preco_unitario, 2,',','.')}}</td> 
                                        <td id="center">
                                            <a href="{{route('product.edit', $produto->id)}}" 
                                               data-toggle="tooltip" 
                                               data-placement="top"
                                               title="Alterar"><i class="btn btn-info fa fa-pencil"></i></a>
                                            <form style="display: inline-block;" method="POST" 
                                                ...
                                                <button type="submit">
                                                    <a><i class="btn btn-danger fa fa-trash-o"></i></a>
                                                </button>
                                            </form>
                                        </td>               
                                    </tr>
